            ...
            <div className="columns">
              <div className="column is-half authorisation">
                ...
                <div className="homeText">
                  If you want to manage your projects, see what packages are out
                  there and find out what other users are doing.
                </div>
                <div className="homeText">
              ...
              <div className="column is-half  authorisation">
                ...
                {!this.state.register && (
                  <LoginForm
                    handleSubmit={e =>
                      this.props.handleLogin(e, this.state.data)
                    }
                    handleChange={this.handleChange}
                    data={this.state.data}
                    changeState={this.changeState}
      ...
      return (
        <section className="section">
          <div className="container">
            ...
            <div className="blurb">
              If you want to manage your projects, see what packages are out
              there and find out what other users are doing blah blah blah{" "}
            </div>
          </div>
        </section>
      );
